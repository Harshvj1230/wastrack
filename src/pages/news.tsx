      ...
      <div className="md:w-1/2 md:mx-5 text-sm">
        ...
        <Accordion type="single" collapsible className="mt-10">
          <AccordionItem value="item-1" defaultOpen>
            ...
            <AccordionContent>
              <p>
                Recent data shows a 15% increase in water usage in your area
                compared to last month. This uptick can be attributed to several
                factors, including an increase in outdoor activities as the
                weather warms and a rise in the number of households utilizing
                water for gardening and landscaping.
              </p>
              <p>
                The data highlights a growing concern for sustainability,
                prompting local authorities to initiate discussions on how to
                encourage more responsible water usage. Programs are being
                developed to provide residents with tools and resources to track
                their usage, aiming to promote awareness about conservation
                efforts.
              </p>
              <p>
                As community members become more aware of their water
                consumption, they can make informed choices that benefit both
